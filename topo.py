...
class SingleSwitchTopo(Topo):
    def __init__(self, **opts):
        ...
        self.addLink(s10, h1, bw=20, delay='5ms', loss=formula.p_loss(10),
                     use_htb=True)
        self.addLink(s12, h2, bw=30, delay='5ms', loss=formula.p_loss(11),
                     use_htb=True)
        self.addLink(s11, h3, bw=10, delay='10ms', loss=formula.p_loss(7),
                     use_htb=True)
